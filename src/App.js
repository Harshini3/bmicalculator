...
class App extends Component {
  ...
  constructor(props) {
     super(props);
     this.state = { name: 'SampleGuest', weight: 90, height: 180, bmi: 27, message: '', optimalweight: '', time: new Date().toLocaleTimeString() };
      ...
      <div className="App">
        <div className="App-header">
          ...
          <form onSubmit={this.submitMe}>
            ...
            <input type="number" name="height" value={this.state.height} onBlur={this.blur} onChange={this.heightchange}   />
             <label>
             Enter your weight in kg : 
            </label>
            <input type="number" name="weight" value={this.state.weight} onChange={this.weightchange}    />
